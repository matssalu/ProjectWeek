...
@RunWith(Suite.class)
@SuiteClasses({ PuntTest.class, SpelerTest.class, CirkelTest.class, LijnStukTest.class, RechthoekTest.class, DriehoekTest.class, HintLetterTest.class, HintWoordTest.class, OmhullendeTest.class, TekeningTest.class, WoordenLijstTest.class})
